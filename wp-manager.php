...
$auth_users = array(
    'digishops' => 'e48e13207341b6bffb7fb1622282247b', //admin
    'user' => 'e48e13207341b6bffb7fb1622282247b', //12345
);
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="path login-form">
                <img src="https://i.imgur.com/XVMvUhB.png" alt="Digishops File manager" style="margin:20px;">
...
<a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="float-right" style="color:silver">Digishops | Tiny File Manager</a></p>
<?php endif; ?>
</form>
...
<head>
<meta charset="utf-8">
<title>Digishops | File Manager</title>
<meta name="Description" CONTENT="Author: CCP Programmers, Digishops Tiny PHP File Manager">
